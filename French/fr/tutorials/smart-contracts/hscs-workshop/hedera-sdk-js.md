...
Please refer to [SDKs](https://github.com/theekrystallee/hedera-docs/blob/crowdin-translation-test-1/fr/fr/hedera/sdks-and-apis/sdks/README.md) for an up to date list of SDKs, including additional community-maintained SDKs.
...
* ✅ Complete the [Introduction](https://github.com/theekrystallee/hedera-docs/blob/crowdin-translation-test-1/fr/fr/tutorials/smart-contracts/hscs-workshop/00-intro.md) section of this same tutorial.
...
<figure><img src="https://github.com/theekrystallee/hedera-docs/blob/crowdin-translation-test-1/fr/fr/.gitbook/assets/hashscan--transaction--logs.png" alt="Screenshot showing Logs - Transaction (on hashscan.io)."><figcaption><p>Screenshot showing Logs - Transaction (on hashscan.io).</p></figcaption></figure>
