...
![Account EVM address in Hashscan, before account is created, with annotated items to check.](https://github.com/theekrystallee/hedera-docs/blob/crowdin-translation-test-1/fr/fr/.gitbook/assets/hello-world--account--faucet-hashscan-before.drawing.svg)
...
![Input EVM address in Hedera Faucet, with annotated items.](https://github.com/theekrystallee/hedera-docs/blob/crowdin-translation-test-1/fr/fr/.gitbook/assets/hello-world--account--faucet-input-address.drawing.svg)
...
![Confirm transaction in Hedera Faucet, with annotated items.](https://github.com/theekrystallee/hedera-docs/blob/crowdin-translation-test-1/fr/fr/.gitbook/assets/hello-world--account--faucet-confirm.drawing.svg)
...
![Success dialog upon create and fund account in Hedera Faucet, with annotated items.](https://github.com/theekrystallee/hedera-docs/blob/crowdin-translation-test-1/fr/fr/.gitbook/assets/hello-world--account--faucet-transfer-complete.drawing.svg)
...
![Account EVM address in Hashscan, after account is created and funded, with annotated items to check.](https://github.com/theekrystallee/hedera-docs/blob/crowdin-translation-test-1/fr/fr/.gitbook/assets/hello-world--account--faucet-hashscan-after.drawing.svg)
