...
=======
### [Build v0.62.3](https://github.com/hiero-ledger/hiero-consensus-node/releases/tag/v0.62.3)
>>>>>>> 68a1bb9 (update script-minor nug)

<details>
<summary><strong>What's Changed</strong></summary>

* * fix: Fix the transactionFee in the record for ConsensusSubmitMessage with custom fees by @Neeharika-Sompalli in https://github.com/hiero-ledger/hiero-consensus-node/pull/19198
* * chore: Remove `AtomicBatch` from prod throttles by @tinker-michaelj in https://github.com/hiero-ledger/hiero-consensus-node/pull/19216
* * feat: Bump PBJ version and use Block Stream Publish Service by @derektriley in https://github.com/hiero-ledger/hiero-consensus-node/pull/19256
* * chore: (0.62) Use app fee charging mechanisms for gas by @tinker-michaelj in https://github.com/hiero-ledger/hiero-consensus-node/pull/19254
* **Full Changelog**: https://github.com/hiero-ledger/hiero-consensus-node/compare/v0.62.2...v0.62.3

**Full Changelog**: [v0.62.0...v0.62.3](https://github.com/hiero-ledger/hiero-consensus-node/compare/v0.62.0...v0.62.3)
...
### [Build v0.61.7](https://github.com/hiero-ledger/hiero-consensus-node/releases/tag/v0.61.7)

<details>
<summary><strong>What's Changed</strong></summary>

* * fix: Fix the `transactionFee` in the record for `ConsensusSubmitMessage` with custom fees by @Neeharika-Sompalli in https://github.com/hiero-ledger/hiero-consensus-node/pull/19195
* * chore: Disable `AtomicBatch` prod throttles by @tinker-michaelj in https://github.com/hiero-ledger/hiero-consensus-node/pull/19217
* **Full Changelog**: https://github.com/hiero-ledger/hiero-consensus-node/compare/v0.61.6...v0.61.7

**Full Changelog**: [v0.61.0...v0.61.7](https://github.com/hiero-ledger/hiero-consensus-node/compare/v0.61.0...v0.61.7)

</details>

### [Build v0.61.6](https://github.com/hiero-ledger/hiero-consensus-node/releases/tag/v0.61.6)

<details>
<summary><strong>What's Changed</strong></summary>

* * chore: Config changes for batch transactions by @Neeharika-Sompalli in https://github.com/hiero-ledger/hiero-consensus-node/pull/19127
* **Full Changelog**: https://github.com/hiero-ledger/hiero-consensus-node/compare/v0.61.5...v0.61.6

**Full Changelog**: [v0.61.0...v0.61.6](https://github.com/hiero-ledger/hiero-consensus-node/compare/v0.61.0...v0.61.6)

</details>

### [Build v0.61.5](https://github.com/hiero-ledger/hiero-consensus-node/releases/tag/v0.61.5)

<details>
<summary><strong>What's Changed</strong></summary>

* * chore: Disable Batch Transactions  by @Neeharika-Sompalli in https://github.com/hiero-ledger/hiero-consensus-node/pull/19114
* **Full Changelog**: https://github.com/hiero-ledger/hiero-consensus-node/compare/v0.61.4...v0.61.5

**Full Changelog**: [v0.61.0...v0.61.5](https://github.com/hiero-ledger/hiero-consensus-node/compare/v0.61.0...v0.61.5)

</details>

### [Build v0.61.4](https://github.com/hiero-ledger/hiero-consensus-node/releases/tag/v0.61.4)

<details>
<summary><strong>What's Changed</strong></summary>

* * fix: 0.61 cherry-pick: Correctly populate sysfiles with node info by @mhess-swl in https://github.com/hiero-ledger/hiero-consensus-node/pull/18884
* * fix: 18771: Backport fixes for 18593, 18795, 18844, and 18903 to release 0.61 by @artemananiev in https://github.com/hiero-ledger/hiero-consensus-node/pull/18799
* * chore: (0.61) add fee refund mechanism, use for successful EthereumTransaction by @tinker-michaelj in https://github.com/hiero-ledger/hiero-consensus-node/pull/18913
* **Full Changelog**: https://github.com/hiero-ledger/hiero-consensus-node/compare/v0.61.3...v0.61.4

**Full Changelog**: [v0.61.0...v0.61.4](https://github.com/hiero-ledger/hiero-consensus-node/compare/v0.61.0...v0.61.4)

</details>

### [Build v0.61.3](https://github.com/hiero-ledger/hiero-consensus-node/releases/tag/v0.61.3)

<details>
<summary><strong>What's Changed</strong></summary>

* * chore: (cherry-pick) Update flow-pull-request-formatting.yaml by @derektriley in https://github.com/hiero-ledger/hiero-consensus-node/pull/18792
* * chore: (cherry-pick) adjust path to protobufs in 'Update Hedera Protobufs' step by @derektriley in https://github.com/hiero-ledger/hiero-consensus-node/pull/18787
* * chore: (cherry-pick) remove github-committers team from codeowners by @derektriley in https://github.com/hiero-ledger/hiero-consensus-node/pull/18808
* * chore: (cherry-pick) Update CODEOWNERS for tools-and-libs rename by @derektriley in https://github.com/hiero-ledger/hiero-consensus-node/pull/18788
* * chore: (cherry-pick) update codeowners with new team names by @derektriley in https://github.com/hiero-ledger/hiero-consensus-node/pull/18807
* * fix: Cherry-pick `transactionFee` fix for atomic batch transactions by @Neeharika-Sompalli in https://github.com/hiero-ledger/hiero-consensus-node/pull/18853
* **Full Changelog**: https://github.com/hiero-ledger/hiero-consensus-node/compare/v0.61.2...v0.61.3

**Full Changelog**: [v0.61.0...v0.61.3](https://github.com/hiero-ledger/hiero-consensus-node/compare/v0.61.0...v0.61.3)

</details>

### [Build v0.61.2](https://github.com/hiero-ledger/hiero-consensus-node/releases/tag/v0.61.2)

<details>
<summary><strong>What's Changed</strong></summary>

* * chore: (cherry-pick) Delay initializing snark keys (#18699) by @Neeharika-Sompalli in https://github.com/hiero-ledger/hiero-consensus-node/pull/18701
* * fix: (cherry-pick) Utilize more than one thread for SSL accept handling (#18557) by @abies in https://github.com/hiero-ledger/hiero-consensus-node/pull/18586
* * fix: 18720: Backport the fix for 18571 to release 0.61 by @artemananiev in https://github.com/hiero-ledger/hiero-consensus-node/pull/18736
* * feat: (cherry-pick) try using non-zero realm/shard by @derektriley in https://github.com/hiero-ledger/hiero-consensus-node/pull/18732
* **Full Changelog**: https://github.com/hiero-ledger/hiero-consensus-node/compare/v0.61.1...v0.61.2

**Full Changelog**: [v0.61.0...v0.61.2](https://github.com/hiero-ledger/hiero-consensus-node/compare/v0.61.0...v0.61.2)

</details>

### [Build v0.61.1](https://github.com/hiero-ledger/hiero-consensus-node/releases/tag/v0.61.1)

<details>
<summary><strong>What's Changed</strong></summary>

* * chore: Remove the entityCounts migration code in 0.61 (#18500) by @Neeharika-Sompalli in https://github.com/hiero-ledger/hiero-consensus-node/pull/18511
* * refactor: cherry-pick "Use a list of signed bytes for transactions in AtomicBatchTransaction" by @ibankov in https://github.com/hiero-ledger/hiero-consensus-node/pull/18522
* * fix: State changes out of order in HAPI Tests (Restart) by @derektriley in https://github.com/hiero-ledger/hiero-consensus-node/pull/18564
* * fix: 18410: Bucket integrity check in HDHM.ReadUpdateBucketTask can be improved - rel/0.61 by @imalygin in https://github.com/hiero-ledger/hiero-consensus-node/pull/18505
* * fix: Ensure `BlockStreamManager#endRound()` is called after dispatching by @tinker-michaelj in https://github.com/hiero-ledger/hiero-consensus-node/pull/18562
* * feat: Cherry-pick Daily Node Rewards by @Neeharika-Sompalli in https://github.com/hiero-ledger/hiero-consensus-node/pull/18570
* * fix: Call `BlockRecordManager.endRound` after system dispatch by @Neeharika-Sompalli in https://github.com/hiero-ledger/hiero-consensus-node/pull/18621
* * fix: Only "go back" in cons time for post-restart system work by @tinker-michaelj in https://github.com/hiero-ledger/hiero-consensus-node/pull/18660
* * chore: cherry-pick fix NPE when using records by @Neeharika-Sompalli in https://github.com/hiero-ledger/hiero-consensus-node/pull/18679
* * chore: Cherry-pick Add metrics for active node percentage by @Neeharika-Sompalli in https://github.com/hiero-ledger/hiero-consensus-node/pull/18680
* **Full Changelog**: https://github.com/hiero-ledger/hiero-consensus-node/compare/v0.61.0...v0.61.1

**Full Changelog**: [v0.61.0...v0.61.1](https://github.com/hiero-ledger/hiero-consensus-node/compare/v0.61.0...v0.61.1)

</details>

### [Build v0.61.0](https://github.com/hiero-ledger/hiero-consensus-node/releases/tag/v0.61.0)
...
**Full Changelog**: [v0.61.0...v0.61.0](https://github.com/hiero-ledger/hiero-consensus-node/compare/v0.61.0...v0.61.0)
