...
* ✅ Complete the [Introduction](https://github.com/hashgraph/hedera-docs/blob/translation-staging/tutorials/smart-contracts/hscs-workshop/00-intro.md) section of this same tutorial.
* ✅ Optionally, complete the [Hedera SDK JS](https://github.com/hashgraph/hedera-docs/blob/translation-staging/tutorials/smart-contracts/hscs-workshop/01-hederasdkjs.md) section of this tutorial.
...
* If it does not exist, or does not have balance, you'll need to create or fund it before proceeding
  * To do so, you'll need to repeat [_Step B4: Fund several Hedera EVM accounts_](https://github.com/hashgraph/hedera-docs/blob/translation-staging/tutorials/smart-contracts/setup/README.md#step-b4-fund-several-hedera-evm-accounts) from the Setup section of this tutorial.
