...
[![](../../.gitbook/assets/hello-world--hscs--arkhia-01-create-project.png)](https://github.com/hashgraph/hedera-docs/blob/translation-staging/.gitbook/assets/hello-world--account--arkhia-01-create-project.png)

3. Fill in whatever you like in the modal dialog that pops up.

[![](../../.gitbook/assets/hello-world--hscs--arkhia-02-project-form.png)](https://github.com/hashgraph/hedera-docs/blob/translation-staging/.gitbook/assets/hello-world--account--arkhia-02-project-form/README.md)

4. Click on the "Manage" button on the right side of your newly created project.

[<img src="../../.gitbook/assets/hello-world--hscs--arkhia-03-manage-project.png" alt="" data-size="original">](https://github.com/hashgraph/hedera-docs/blob/translation-staging/.gitbook/assets/hello-world--account--arkhia-03-manage-project/README.md)
