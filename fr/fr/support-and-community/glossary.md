...
Short for operation codes, [opcodes](https://github.com/hashgraph/hedera-docs/blob/translation-staging/support-and-community/broken-reference/README.md) are the low-level human-readable instructions of the program.
