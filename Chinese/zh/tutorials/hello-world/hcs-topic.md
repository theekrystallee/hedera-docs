...
![HCS topic in Hashscan, with annotated items to check.](https://github.com/theekrystallee/hedera-docs/blob/crowdin-translation-test-1/zh-CN/zh/.gitbook/assets/hello-world--hcs--topic.drawing.svg)
